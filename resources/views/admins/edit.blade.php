...
<body class="bg-gray-50 p-6 md:p-10 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto flex justify-between items-start mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Edit akun admin</p>
        </div>
    ...
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-8" style="box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Form Edit Admin</h2>
        ...
        <form action="{{ route('admins.update', $admin->id_admin) }}" method="POST" class="flex flex-col gap-5">
            @csrf
            @method('PUT')
            
            <div class="relative w-full">
                <label class="block text-sm font-medium text-gray-700 mb-1">Username</label>
                <input type="text" name="username" placeholder="Masukkan username" value="{{ $admin->username }}"
            ...
            <div class="relative w-full">
                <label class="block text-sm font-medium text-gray-700 mb-1">Password Baru <span class="font-normal text-gray-400 text-xs ml-1">(Kosongkan jika tidak diubah)</span></label>
                <div class="relative">
