...
<body>
    <div class="sa-container" style="max-width: 600px;">
        ...
        <div class="sa-card">
            ...
            <form action="{{ route('admins.store') }}" method="POST" class="sa-form">
                @csrf
                
                <div class="sa-form-group">
                    <label class="sa-form-label">Username</label>
                    <input type="text" name="username" placeholder="Masukkan username" class="sa-form-input" required>
                ...
                <div class="sa-form-group">
                    ...
                    <div style="position: relative;">
                        <input type="password" id="password" name="password" placeholder="Masukkan password" class="sa-form-input" required oninput="checkPasswordStrength(this.value)">
                ...
                <div class="password-req">
                    <p id="req-length"><i class="fa fa-circle text-[8px]"></i> Minimal 8 karakter</p>
                    <p id="req-upper"><i class="fa fa-circle text-[8px]"></i> Mengandung huruf besar (A-Z)</p>
                    <p id="req-special"><i class="fa fa-circle text-[8px]"></i> Mengandung karakter spesial (!?@#$%^&* dll)</p>
                </div>
