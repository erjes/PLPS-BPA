...
@section('content')
    ...
    @if(session('error'))
        <div class="card" style="background:#fef2f2;border:1px solid #fecaca;color:#991b1b">{!! nl2br(session('error')) !!}
        </div>
    @endif
    ...
    @else
        ...
        <div class="card" id="filterCard">
            ...
            <form method="GET" action="/dashboard" id="filterForm">
                <div class="filter-grid">
                    ...
                    <div class="ms-dropdown" data-name="program_id" data-label="Program">
                        ...
                        <div class="ms-panel">
                            <div class="ms-panel-header">
                                <label><input type="checkbox" class="ms-select-all" onchange="toggleAll(this)"> Pilih
                                    Semua</label>
                            </div>
                            <div class="ms-search"><input type="text" placeholder="Cari program..."
                                    oninput="searchOptions(this)"></div>
                    ...
                    <div class="ms-dropdown" data-name="sub_program_id" data-label="Sub Program">
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-search"><input type="text" placeholder="Cari sub program..."
                                    oninput="searchOptions(this)"></div>
                            <div class="ms-options">
                    ...
                    <div class="ms-dropdown" data-name="fakultas_id" data-label="Fakultas">
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-search"><input type="text" placeholder="Cari fakultas..."
                                    oninput="searchOptions(this)"></div>
                            <div class="ms-options">
                    ...
                    <div class="ms-dropdown" data-name="prodi_id" data-label="Prodi">
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-search"><input type="text" placeholder="Cari prodi..." oninput="searchOptions(this)">
                            </div>
                            <div class="ms-options">
                                @foreach($prodi as $pr)
                    ...
                    <div class="ms-dropdown" data-name="mitra_id" data-label="Mitra">
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-search"><input type="text" placeholder="Cari mitra..." oninput="searchOptions(this)">
                            </div>
                            <div class="ms-options">
                    ...
                    <div class="ms-dropdown" data-name="semester_ta" data-label="Semester TA">
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-search"><input type="text" placeholder="Cari semester TA..."
                                    oninput="searchOptions(this)"></div>
                            <div class="ms-options">
                                @foreach($allSemesterTa ?? [] as $staObj)
                                    @php $isChecked = in_array($staObj->semester_ta, $semesterTaValues); @endphp
                                    <label class="ms-option" data-id="{{ $staObj->semester_ta }}"
                                        data-initial-count="{{ $staObj->total }}">
                    ...
                    <div class="ms-dropdown" data-name="tahun_ajaran" data-label="Tahun Ajaran">
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-search"><input type="text" placeholder="Cari tahun ajaran..."
                                    oninput="searchOptions(this)"></div>
                            <div class="ms-options">
                                @foreach($allTahunAjaran ?? [] as $taObj)
                                    ...
                                    <label class="ms-option" data-id="{{ $taObj->tahun_ajaran }}"
                                        data-initial-count="{{ $taObj->total }}">
                ...
                <div class="filter-actions">
                    ...
                    <button type="button" class="btn btn-outline" onclick="openExportModal()"><i class="fas fa-download"></i>
                        Export</button>
                    <button type="button" class="btn btn-primary" onclick="applyDashboardFilter()"><i class="fas fa-search"></i> Terapkan Filter</button>
                </div>
            </form>
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div>
                    <div class="value" id="statTotalMahasiswa">{{ number_format($totalMahasiswa) }}</div>
                    <div class="label">Total Mahasiswa PLPS</div>
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-icon" style="background:#eff6ff;color:#2563eb"><i class="fas fa-building"></i></div>
                <div>
                    <div class="value" id="statTotalMitra">{{ number_format($totalMitra) }}</div>
            ...
            <div class="summary-card">
                ...
                <div>
                    <div class="value" id="statTotalProgram">{{ number_format($totalProgram) }}</div>
            ...
            <div class="summary-card">
                ...
                <div>
                    <div class="value" id="statTotalSubProgram">{{ number_format($totalSubProgram) }}</div>
                    <div class="label">Total Sub Program</div>
                </div>
            </div>
        </div>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px">
            ...
            <div class="card">
                ...
                <div style="display:flex;align-items:center;margin-bottom:20px">
                    <div style="width:100px;height:100px;position:relative;flex-shrink:0">
                        ...
                        <div
                            style="position:absolute;top:0;left:0;right:0;bottom:0;display:flex;flex-direction:column;align-items:center;justify-content:center;font-size:16px;font-weight:700;color:#1e293b">
                            <span id="pctEksternal">0%</span>
                            <span style="font-size:10px;font-weight:500;color:#64748b;margin-top:-2px">dari total</span>
                        </div>
                    </div>
                    <div style="flex:1;text-align:center">
                        <div style="font-size:36px;font-weight:800;color:#2173b5;line-height:1" id="statMitraEksternal">
                            {{ number_format($totalMitraEksternal) }}</div>
                        <div style="font-size:12px;color:#64748b;font-weight:500;margin-top:6px">Total Mitra Eksternal</div>
                    </div>
                </div>
                <div style="font-size:12px;font-weight:700;margin-bottom:12px;text-transform:uppercase;color:#475569">Top 5
                    Mitra Eksternal</div>
                <div id="mitraEksternalList">
                    ...
                    <ul class="mitra-list">
                        ...
                        @foreach($topMitraEksternal as $i => $mt)
                            <li style="display:flex;align-items:center;padding:10px 0;gap:14px;border-bottom:none">
                                ...
                                <div style="flex:1">
                                    <div style="font-size:13px;margin-bottom:6px;font-weight:500;color:#334155">{{ $mt->nama_mitra }}
                                    </div>
                                    <div style="background:#f1f5f9;height:6px;border-radius:3px;width:100%;overflow:hidden">
                                        <div
                                            style="height:100%;background:#2173b5;border-radius:3px;width:{{ $maxEks > 0 ? ($mt->total / $maxEks) * 100 : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                                <div style="font-size:13px;font-weight:600;width:32px;text-align:right;color:#1e293b">
                                    {{ number_format($mt->total) }}</div>
                            </li>
                        @endforeach
                    </ul>
                @endif
            ...
            <div class="card">
                ...
                <div style="display:flex;align-items:center;margin-bottom:20px">
                    ...
                    <div style="flex:1;text-align:center">
                        <div style="font-size:36px;font-weight:800;color:#0f766e;line-height:1" id="statMitraInternal">
                            {{ number_format($totalMitraInternal) }}</div>
                        <div style="font-size:12px;color:#64748b;font-weight:500;margin-top:6px">Total Mitra Internal</div>
                    </div>
                </div>
                <div style="font-size:12px;font-weight:700;margin-bottom:12px;text-transform:uppercase;color:#475569">Top 5
                    Mitra Internal</div>
                <div id="mitraInternalList">
                        ...
                        @foreach($topMitraInternal as $i => $mt)
                            <li style="display:flex;align-items:center;padding:10px 0;gap:14px;border-bottom:none">
                                ...
                                <div style="flex:1">
                                    ...
                                    <div style="background:#f1f5f9;height:6px;border-radius:3px;width:100%;overflow:hidden">
                                        <div
                                            style="height:100%;background:#0f766e;border-radius:3px;width:{{ $maxInt > 0 ? ($mt->total / $maxInt) * 100 : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                                <div style="font-size:13px;font-weight:600;width:32px;text-align:right;color:#1e293b">
        ...
        <div class="card" style="margin-bottom:20px;padding-bottom:30px">
            <div
                style="font-size:14px;font-weight:700;margin-bottom:24px;text-transform:uppercase;color:#1e293b;letter-spacing:0.5px">
                Distribusi Per Program MBKM</div>
            <div id="distribusiProgramContainer">
                    ...
                    @foreach($distribusiProgram as $i => $prog)
                        <div style="display:flex;align-items:center;gap:20px">
                            ...
                            <div style="flex:1;background:transparent;height:12px;display:flex;align-items:center">
                                <div
                                    style="height:12px;background:{{ $progColorsList[$i % count($progColorsList)] }};border-radius:6px;width:{{ $maxProg > 0 ? ($prog->total / $maxProg) * 100 : 0 }}%">
                                </div>
                            </div>
                            <div style="width:80px;text-align:right;font-size:14px;font-weight:500;color:#1e293b">
                                {{ number_format($prog->total, 0, ',', '.') }}</div>
                        </div>
                    @endforeach
                </div>
            @endif
        ...
        <div class="card" id="tableCard">
            ...
            <div class="search-bar" id="tableSearchBar">
                ...
                @if($isAdmin ?? false)
                    <button type="button" class="btn btn-danger" onclick="resetAllData()" style="margin-left: auto;"><i class="fas fa-trash-alt"></i> Reset Data</button>
                @endif
            </div>

            @if($isAdmin ?? false)
                <div class="bulk-toolbar" id="bulkToolbar">
                    <span class="bulk-count"><i class="fas fa-check-square"></i> <span id="selectedCount">0</span> data
                        dipilih</span>
                    <button type="button" class="btn btn-danger" onclick="bulkDeleteSelected()"><i class="fas fa-trash"></i> Hapus
                        Terpilih</button>
                    <button type="button" class="btn btn-outline" onclick="clearAllSelections()" style="font-size:13px"><i
            ...
            <div class="table-wrap" id="tableWrap">
                <table class="data-table" id="lazyTable">
                    <thead>
                        <tr>
                            @if($isAdmin ?? false)
                                <th style="width:40px"><input type="checkbox" id="selectAllRows" onchange="toggleSelectAll(this)"
                            title="Pilih Semua"></th>@endif
                            <th>No</th>
                            <th>Program</th>
                            <th>Sub Program</th>
                            <th>Fakultas</th>
                            ...
                            @if($isAdmin ?? false)
                            <th style="width:60px">Aksi</th>@endif
                        </tr>
                    </thead>
                    <tbody id="tableBody">
                    </tbody>
            ...
            <div class="table-info" id="tableInfo"
                style="display:none; justify-content:flex-end; align-items:center; padding: 15px 20px;">
                <div class="pagination-controls" style="display:flex; gap:15px; align-items:center;">
                    ...
                    <div style="display:flex; gap:5px;">
                        <button class="btn btn-outline" id="prevPageBtn" onclick="prevPage()" style="padding:6px 12px"
                            title="Previous Page"><i class="fas fa-chevron-left"></i></button>
                        <button class="btn btn-outline" id="nextPageBtn" onclick="nextPage()" style="padding:6px 12px"
                            title="Next Page"><i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
            </div>
        ...
        {{-- EDIT MODAL --}}
        @if($isAdmin ?? false)
            <div class="edit-modal-overlay" id="editModalOverlay" onmousedown="if(event.target===this)this.dataset.close='1';"
                onmouseup="if(this.dataset.close==='1' && event.target===this){closeEditModal();} this.dataset.close='0';">
                <div class="edit-modal">
                    ...
                    <div class="edit-modal-footer">
                        ...
                        <button class="btn btn-primary" id="editSaveBtn" onclick="saveEdit()"><i class="fas fa-save"></i>
                            Simpan</button>
                    </div>
                </div>
            </div>
        ...
        {{-- EXPORT MODAL --}}
        <div class="edit-modal-overlay" id="exportModalOverlay" onmousedown="if(event.target===this)this.dataset.close='1';"
            onmouseup="if(this.dataset.close==='1' && event.target===this){closeExportModal();} this.dataset.close='0';">
            <div class="edit-modal" style="max-width:420px;text-align:center">
                <div class="edit-modal-header">
                ...
                <div class="edit-modal-body" style="padding:24px 28px">
                    <p style="margin-bottom:12px;font-size:14px;color:#475569">Pilih format file untuk mengunduh laporan sesuai
                        filter yang sedang aktif.</p>
                    {{-- Active filter summary shown here by JS --}}
                    <div id="exportFilterSummary" style="margin-bottom:20px;text-align:left"></div>
                    <div style="display:flex;gap:15px;justify-content:center">
                        <button type="button" class="btn btn-outline" onclick="doExport('excel')"
                            style="flex:1;padding:15px;color:#0f766e;border-color:#0f766e">
                            <i class="fas fa-file-excel" style="font-size:24px;margin-bottom:8px;display:block"></i> Excel
                        </button>
                        <button type="button" class="btn btn-outline" onclick="doExport('pdf')"
                            style="flex:1;padding:15px;color:#b91c1c;border-color:#b91c1c">
        ...
        <div class="edit-modal-overlay" id="deleteConfirmOverlay" onmousedown="if(event.target===this)this.dataset.close='1';"
            onmouseup="if(this.dataset.close==='1' && event.target===this){closeDeleteModal();} this.dataset.close='0';">
            <div class="edit-modal" style="max-width:440px;text-align:center">
                <div class="edit-modal-header" style="border-bottom:none;padding-bottom:0">
                    <h3 style="color:#b91c1c"><i class="fas fa-exclamation-triangle" style="color:#dc2626"></i> Konfirmasi Hapus
                        Data</h3>
                    <button class="edit-modal-close" onclick="closeDeleteModal()">&times;</button>
                </div>
                <div class="edit-modal-body" style="padding:20px 24px">
                    <div
                        style="width:60px;height:60px;border-radius:50%;background:#fef2f2;color:#dc2626;display:flex;align-items:center;justify-content:center;font-size:28px;margin:0 auto 16px">
                        <i class="fas fa-trash-alt"></i>
                    </div>
                    <p style="font-size:15px;color:#1e293b;font-weight:600;margin-bottom:8px">Apakah Anda yakin ingin menghapus
                        data?</p>
                    <p style="font-size:13px;color:#64748b;line-height:1.5" id="deleteConfirmText">Tindakan ini akan menghapus
                        data terpilih secara permanen dari database dan tidak dapat dibatalkan.</p>
                </div>
                <div class="edit-modal-footer"
                    style="justify-content:center;gap:12px;background:#f8fafc;border-top:1px solid #e2e8f0;border-radius:0 0 16px 16px">
                    <button class="btn btn-outline" onclick="closeDeleteModal()" style="padding:10px 20px">Batal</button>
                    <button class="btn btn-red" id="confirmDeleteBtn" onclick="executeBulkDelete()"
        ...
        @if($isAdmin ?? false)
            ...
            <div class="edit-modal-overlay" id="resetConfirmOverlay" onmousedown="if(event.target===this)this.dataset.close='1';"
                onmouseup="if(this.dataset.close==='1' && event.target===this){closeResetModal();} this.dataset.close='0';">
                <div class="edit-modal" style="max-width:440px;text-align:center">
                    <div class="edit-modal-header" style="border-bottom:none;padding-bottom:0">
                        <h3 style="color:#b91c1c"><i class="fas fa-exclamation-triangle" style="color:#dc2626"></i> Konfirmasi Reset
                            Data</h3>
                        <button class="edit-modal-close" onclick="closeResetModal()">&times;</button>
                    </div>
                    <div class="edit-modal-body" style="padding:20px 24px">
                        <div
                            style="width:60px;height:60px;border-radius:50%;background:#fef2f2;color:#dc2626;display:flex;align-items:center;justify-content:center;font-size:28px;margin:0 auto 16px">
                        ...
                        <p style="font-size:15px;color:#1e293b;font-weight:600;margin-bottom:8px">Apakah Anda yakin ingin mereset
                            semua data?</p>
                        <p style="font-size:13px;color:#64748b;line-height:1.5">Tindakan ini akan menghapus seluruh data mahasiswa
                            MBKM, termasuk mahasiswa, prodi, program, sub program, kegiatan, mitra, dan riwayat import secara
                            permanen dari database. Tindakan ini tidak dapat dibatalkan.</p>
                    </div>
                    <div class="edit-modal-footer"
                        style="justify-content:center;gap:12px;background:#f8fafc;border-top:1px solid #e2e8f0;border-radius:0 0 16px 16px">
                        <button class="btn btn-outline" onclick="closeResetModal()" style="padding:10px 20px">Batal</button>
                        <button class="btn btn-red" id="confirmResetBtn" onclick="executeResetData()"
                            style="padding:10px 24px;background:#dc2626">
        ...
        <div class="edit-modal-overlay" id="dashboardErrorOverlay" onmousedown="if(event.target===this)this.dataset.close='1';"
            onmouseup="if(this.dataset.close==='1' && event.target===this){closeDashboardErrorModal();} this.dataset.close='0';">
            <div class="edit-modal" style="max-width:460px">
                <div class="edit-modal-header"
                    style="background:#fef2f2;border-bottom:1px solid #fecaca;border-radius:16px 16px 0 0">
                    <h3 style="color:#991b1b;font-size:16px;display:flex;align-items:center;gap:8px">
                        <i class="fas fa-exclamation-circle" style="color:#dc2626;font-size:18px"></i> <span
                            id="dashboardErrorTitle">Kesalahan Validasi</span>
                    </h3>
        ...
        <script>
            ...
            // 1. Tren Per Semester (Line) — store to window._chartTren for AJAX updates
            ...
            window._chartTren = new Chart(document.getElementById('chartTren'), {
                type: 'line',
            ...
            // 2. Top 5 Fakultas — store to window._chartFakultas
            const fakLabels = @json($mahasiswaPerFakultas->pluck('nama_fakultas'));
            const fakData = @json($mahasiswaPerFakultas->pluck('total'));
            window._chartFakultas = new Chart(document.getElementById('chartFakultas'), {
            ...
            // 3. Top 5 Prodi (Horizontal Bar) — store to window._chartProdi
            ...
            window._chartProdi = new Chart(document.getElementById('chartProdi'), {
                    ...
                    scales: {
                        ...
                        y: {
                            grid: { display: false }, ticks: {
                                font: { size: 11 }, autoSkip: false, callback: function (value) {
            ...
            // 4. Top 5 Program (Horizontal Bar) — store to window._chartProgram
            ...
            window._chartProgram = new Chart(document.getElementById('chartProgram'), {
            ...
            // MITRA DOUGHNUT CHARTS — store to window._chartMitraEksternal/_chartMitraInternal
            ...
            if (document.getElementById('chartMitraEksternal')) {
                window._chartMitraEksternal = new Chart(document.getElementById('chartMitraEksternal'), {
                    type: 'doughnut',
                    data: {
                        datasets: [{
            ...
            if (document.getElementById('chartMitraInternal')) {
                window._chartMitraInternal = new Chart(document.getElementById('chartMitraInternal'), {
                    type: 'doughnut',
                    data: {
                        datasets: [{
             ...
             * Updates charts, summary cards, and data table all at once via AJAX.
             *
             * NOTE: fetchDashboardData and resetAndLoadTable are defined in dashboard.js
             * (Vite ES module), so they must be accessed via window.xxx explicitly —
             * "typeof fetchDashboardData" would return 'undefined' due to module scope.
             */
            function applyDashboardFilter() {
                // Update charts + summary cards (from Vite module via window export)
                if (window.fetchDashboardData) window.fetchDashboardData();
                // Update table data (from Vite module via window export)
                if (window.resetAndLoadTable) window.resetAndLoadTable();
                // Update cascading filter counts (defined in this inline script, global scope)
                if (typeof fetchFilterOptions === 'function') fetchFilterOptions();
            }
